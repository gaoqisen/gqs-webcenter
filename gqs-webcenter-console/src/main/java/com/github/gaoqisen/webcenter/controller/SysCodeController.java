...
import com.github.gaoqisen.webcenter.utils.SecretKeyUtils;
...
public class SysCodeController {
	...
	public Result queryAllInfo() {
		...
		for (SysCode sysCode : list) {
			...
			hashMap.put("restList", this.sysRestService
					.list(new QueryWrapper<SysRest>().eq(SysCode.COL_APPLICATION_NAME, sysCode.getApplicationName())));
