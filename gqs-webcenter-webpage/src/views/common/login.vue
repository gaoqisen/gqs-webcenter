    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <h2 class="brand-info__text">WebCenterConsole</h2>
  ...
  export default {
    ...
    methods: {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            // 系统登录
            this.$http({
              url: this.$http.adornUrl('/main/login'),
              method: 'post',
              data: this.$http.adornData({
                'username': this.dataForm.userName,
                'password': this.dataForm.password,
      ...
      getCaptcha () {
        ...
        this.captchaPath = this.$http.adornUrl(`/main/captcha.jpg?uuid=${this.dataForm.uuid}`)
      }
    }
  }
</script>
